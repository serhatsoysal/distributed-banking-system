...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=serhatsoysal_distributed-banking-system&metric=alert_status)](https://sonarcloud.io/dashboard?id=serhatsoysal_distributed-banking-system)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=serhatsoysal_distributed-banking-system&metric=coverage)](https://sonarcloud.io/dashboard?id=serhatsoysal_distributed-banking-system)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=serhatsoysal_distributed-banking-system&metric=code_smells)](https://sonarcloud.io/dashboard?id=serhatsoysal_distributed-banking-system)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=serhatsoysal_distributed-banking-system&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=serhatsoysal_distributed-banking-system)
